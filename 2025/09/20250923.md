...
| 排名        |  项目名      | Star⭐       | 今日增长量   |
|------------|------------|---------------|---------------- |
| 1 |  [OpenCut-app/OpenCut](https://github.com/OpenCut-app/OpenCut)| 35.1k  | 🔺1174 |
| 2 |  [Alibaba-NLP/DeepResearch](https://github.com/Alibaba-NLP/DeepResearch)| 14.2k  | 🔺497 |
| 3 |  [ajeetdsouza/zoxide](https://github.com/ajeetdsouza/zoxide)| 30k  | 🔺262 |
| 4 |  [microsoft/ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)| 39.4k  | 🔺151 |
| 5 |  [DS4SD/docling](https://github.com/DS4SD/docling)| 39.5k  | 🔺125 |
| 6 |  [datawhalechina/happy-llm](https://github.com/datawhalechina/happy-llm)| 18k  | 🔺112 |
| 7 |  [eslint/eslint](https://github.com/eslint/eslint)| 26.5k  | 🔺111 |
| 8 |  [Predidit/Kazumi](https://github.com/Predidit/Kazumi)| 16.1k  | 🔺88 |
| 9 |  [anthropics/claude-code](https://github.com/anthropics/claude-code)| 34k  | 🔺86 |
| 10 |  [moeru-ai/airi](https://github.com/moeru-ai/airi)| 14.4k  | 🔺66 |
...
<h3 style="margin-top: 30px;margin-bottom: 15px;font-weight: bold;border-bottom: 2px solid rgb(239, 112, 96);font-size: 1.0em;"><span style="display: none;"></span><span style="display: inline-block;background: rgb(139, 132, 156);color: rgb(255, 255, 255);padding: 3px 10px 1px;border-top-right-radius: 3px;border-top-left-radius: 3px;margin-right: 3px;">3. 快速目录跳转工具 https://github.com/ajeetdsouza/zoxide</span><span style="display: inline-block;vertical-align: bottom;border-bottom: 36px solid #efebe9;border-right: 20px solid transparent;"> </span></h3>
...
<h3 style="margin-top: 30px;margin-bottom: 15px;font-weight: bold;border-bottom: 2px solid rgb(239, 112, 96);font-size: 1.0em;"><span style="display: none;"></span><span style="display: inline-block;background: rgb(139, 132, 156);color: rgb(255, 255, 255);padding: 3px 10px 1px;border-top-right-radius: 3px;border-top-left-radius: 3px;margin-right: 3px;">7. 代码分析器 https://github.com/eslint/eslint</span><span style="display: inline-block;vertical-align: bottom;border-bottom: 36px solid #efebe9;border-right: 20px solid transparent;"> </span></h3>
...
- 🔺 上月增长数量：245⭐
- 📅 开源时间：2013-06-30
- 📝 项目描述：ESLint静态分析你的代码以快速发现问题。它被内置于大多数文本编辑器中，你可以将ESLint作为持续集成管道的一部分来运行。

    ![](http://photocdn.tv.sohu.com/img/q_mini/20230625/pic_org_92b38f72-cf09-4f46-b658-f7c7351e8588.png)
...
�个项目总结了它在开发场景下的高效用法，是你把 Claude 用出生产力的秘籍。
