## 2025.07.02 最佳开源项目🔝:vscode-copilot-chat
...
| 排名        |  项目名      | Star⭐       | 今日增长量   |
|------------|------------|---------------|---------------- |
| 1 |  [microsoft/vscode-copilot-chat](https://github.com/microsoft/vscode-copilot-chat)| 4.5k  | 🔺624 |
| 2 |  [binwiederhier/ntfy](https://github.com/binwiederhier/ntfy)| 24.3k  | 🔺323 |
| 3 |  [GraphiteEditor/Graphite](https://github.com/GraphiteEditor/Graphite)| 17.6k  | 🔺162 |
| 4 |  [pcottle/learnGitBranching](https://github.com/pcottle/learnGitBranching)| 32k  | 🔺126 |
| 5 |  [Huanshere/VideoLingo](https://github.com/Huanshere/VideoLingo)| 13.7k  | 🔺123 |
| 6 |  [stanford-oval/storm](https://github.com/stanford-oval/storm)| 25.9k  | 🔺121 |
| 7 |  [DS4SD/docling](https://github.com/DS4SD/docling)| 33.5k  | 🔺119 |
| 8 |  [GyulyVGC/sniffnet](https://github.com/GyulyVGC/sniffnet)| 25.5k  | 🔺115 |
| 9 |  [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp)| 13.6k  | 🔺101 |
| 10 |  [m1k1o/neko](https://github.com/m1k1o/neko)| 11.6k  | 🔺77 |
...
- 🔺 上月增长数量：256⭐
- 📅 开源时间：2012-08-14
- 📝 项目描述：一个 Git 命令可视化学习项目。能够生动形象的帮助开发人员理解、学习 Git 命令，通过一系列刺激的关卡挑战，逐步深入的学习 Git 的强大功能。[在线尝试](https://learngitbranching.js.org/)

    ![](https://photocdn.tv.sohu.com/img/github/5405654.png)
...
<h3 style="margin-top: 30px;margin-bottom: 15px;font-weight: bold;border-bottom: 2px solid rgb(239, 112, 96);font-size: 1.0em;"><span style="display: none;"></span><span style="display: inline-block;background: rgb(139, 132, 156);color: rgb(255, 255, 255);padding: 3px 10px 1px;border-top-right-radius: 3px;border-top-left-radius: 3px;margin-right: 3px;">6. 斯坦福开源的 LLM 智能体平台 https://github.com/stanford-oval/storm</span><span style="display: inline-block;vertical-align: bottom;border-bottom: 36px solid #efebe9;border-right: 20px solid transparent;"> </span></h3>
...
<h3 style="margin-top: 30px;margin-bottom: 15px;font-weight: bold;border-bottom: 2px solid rgb(239, 112, 96);font-size: 1.0em;"><span style="display: none;"></span><span style="display: inline-block;background: rgb(139, 132, 156);color: rgb(255, 255, 255);padding: 3px 10px 1px;border-top-right-radius: 3px;border-top-left-radius: 3px;margin-right: 3px;">9.  https://github.com/microsoft/playwright-mcp</span><span style="display: inline-block;vertical-align: bottom;border-bottom: 36px solid #efebe9;border-right: 20px solid transparent;"> </span></h3>
