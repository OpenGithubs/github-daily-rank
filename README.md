...
| 排名        |  项目名      | Star⭐       | 今日增长量   |
|------------|------------|---------------|---------------- |
| 1 |  [rendercv/rendercv](https://github.com/rendercv/rendercv)| 6.5k  | 🔺1506 |
| 2 |  [exo-explore/exo](https://github.com/exo-explore/exo)| 37.8k  | 🔺1003 |
| 3 |  [anthropics/skills](https://github.com/anthropics/skills)| 25.8k  | 🔺897 |
| 4 |  [google/langextract](https://github.com/google/langextract)| 18.6k  | 🔺383 |
| 5 |  [sst/opencode](https://github.com/sst/opencode)| 41.5k  | 🔺382 |
| 6 |  [lintsinghua/DeepAudit](https://github.com/lintsinghua/DeepAudit)| 2.7k  | 🔺328 |
| 7 |  [danielmiessler/Fabric](https://github.com/danielmiessler/Fabric)| 36.3k  | 🔺299 |
| 8 |  [davila7/claude-code-templates](https://github.com/davila7/claude-code-templates)| 13.3k  | 🔺247 |
| 9 |  [datawhalechina/hello-agents](https://github.com/datawhalechina/hello-agents)| 12k  | 🔺244 |
| 10 |  [swisskyrepo/PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings)| 73.6k  | 🔺242 |
...
- 🔺 上月增长数量：686⭐
- 📅 开源时间：2025-09-19
- 📝 项目描述：DeepAudit：人人拥有的 AI 黑客战队，让漏洞挖掘触手可及。国内首个开源代码漏洞挖掘多智能体系统。小白一键部署运行，自主协作审计 + 自动化沙箱 PoC 验证。支持 Ollama 私有部署 ，一键生成报告。​让安全不再昂贵，让审计不再复杂。


<h3 style="margin-top: 30px;margin-bottom: 15px;font-weight: bold;border-bottom: 2px solid rgb(239, 112, 96);font-size: 1.0em;"><span style="display: none;"></span><span style="display: inline-block;background: rgb(139, 132, 156);color: rgb(255, 255, 255);padding: 3px 10px 1px;border-top-right-radius: 3px;border-top-left-radius: 3px;margin-right: 3px;">7. 自动化知识处理框架 https://github.com/danielmiessler/Fabric</span><span style="display: inline-block;vertical-align: bottom;border-bottom: 36px solid #efebe9;border-right: 20px solid transparent;"> </span></h3>
...
<h3 style="margin-top: 30px;margin-bottom: 15px;font-weight: bold;border-bottom: 2px solid rgb(239, 112, 96);font-size: 1.0em;"><span style="display: none;"></span><span style="display: inline-block;background: rgb(139, 132, 156);color: rgb(255, 255, 255);padding: 3px 10px 1px;border-top-right-radius: 3px;border-top-left-radius: 3px;margin-right: 3px;">10. Web应用程序安全和测试有效负载 https://github.com/swisskyrepo/PayloadsAllTheThings</span><span style="display: inline-block;vertical-align: bottom;border-bottom: 36px solid #efebe9;border-right: 20px solid transparent;"> </span></h3>
